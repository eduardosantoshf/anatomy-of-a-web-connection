...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7 \textwidth]{images/browsers.png}
...
\begin{figure}[H]
    ...
    \caption{Output of the \textit{traceroute} command, executed inside UA's network, on 26/03/2021, at 15h12}
\end{figure}
